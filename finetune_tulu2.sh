...
MODEL_DIR="gs://hxtpu_bucket/flan_original_t5_large_sea_ada/"
ACTIVATION_DTYPE=bfloat16
export PYTHONPATH=${PROJECT_DIR}

python3 ${T5X_DIR}/t5x/train.py \
  --gin_search_paths=${PROJECT_DIR} \
  --gin_file="finetune_large_tulu2.gin" \
  --gin.MODEL_DIR=\"${MODEL_DIR}\" \
  --gin.MIXTURE_OR_TASK_NAME=\"tulu_v2\" \
  ...
  --gin.INITIAL_CHECKPOINT_PATH=\"gs://t5-data/pretrained_models/t5x/flan_t5_large/checkpoint_1164000\" \
